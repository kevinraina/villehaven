...
service DevPortalAppPublishRequest {
  ...
  rpc AddReview(app_publish_request.review.AppPRAddReviewRequest) returns (UUID);
  rpc UpdateReview(app_publish_request.review.AppPRUpdateReviewRequest) returns (google.protobuf.Empty);
