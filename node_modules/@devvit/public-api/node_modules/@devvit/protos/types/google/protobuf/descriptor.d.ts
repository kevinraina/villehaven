...
export declare function fieldDescriptorProto_TypeToJSON(object: FieldDescriptorProto_Type): number;
...
export declare function fieldDescriptorProto_LabelToJSON(object: FieldDescriptorProto_Label): number;
/** Describes a oneof. */
...
export declare function fileOptions_OptimizeModeToJSON(object: FileOptions_OptimizeMode): number;
...
export declare function fieldOptions_CTypeToJSON(object: FieldOptions_CType): number;
...
export declare function fieldOptions_JSTypeToJSON(object: FieldOptions_JSType): number;
...
export declare function methodOptions_IdempotencyLevelToJSON(object: MethodOptions_IdempotencyLevel): number;
/**
