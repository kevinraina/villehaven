...
export declare const InstallationSettingsServiceName = "devvit.actor.settings.v1alpha.InstallationSettings";
export declare class InstallationSettingsClientImpl implements InstallationSettings {
 ...
 * Load the saved values with the Settings plugin.
 */
export type InstallationSettingsDefinition = typeof InstallationSettingsDefinition;
export declare const InstallationSettingsDefinition: {
