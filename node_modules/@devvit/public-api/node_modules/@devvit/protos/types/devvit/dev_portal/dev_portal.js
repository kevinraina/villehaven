...
export class DevPortalAppPublishRequestClientImpl {
    ...
    AddReview(request, metadata) {
        const data = AppPRAddReviewRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "AddReview", data, metadata);
        return promise.then((data) => UUID.decode(_m0.Reader.create(data)));
    }
    UpdateReview(request, metadata) {
        const data = AppPRUpdateReviewRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "UpdateReview", data, metadata);
        return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
    }
...
export const DevPortalAppPublishRequestDefinition = {
    ...
    methods: {
        ...
        addReview: {
            name: "AddReview",
            requestType: AppPRAddReviewRequest,
            requestStream: false,
            responseType: UUID,
            responseStream: false,
            options: {},
        ...
        updateReview: {
            name: "UpdateReview",
            requestType: AppPRUpdateReviewRequest,
            requestStream: false,
            responseType: Empty,
            responseStream: false,
            options: {},
