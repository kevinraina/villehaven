...
export const WaitlistServiceName = "devvit.dev_portal.waitlist.Waitlist";
export class WaitlistClientImpl {
    constructor(rpc, opts) {
        this.service = opts?.service || WaitlistServiceName;
        this.rpc = rpc;
        ...
        this.EnsureDeveloperAccountExists = this.EnsureDeveloperAccountExists.bind(this);
    }
    IsCurrentUserRegistered(request, metadata) {
        const data = Empty.encode(request).finish();
        const promise = this.rpc.request(this.service, "IsCurrentUserRegistered", data, metadata);
        return promise.then((data) => IsCurrentUserRegisteredResponse.decode(_m0.Reader.create(data)));
    }
    RegisterUser(request, metadata) {
        ...
        return promise.then((data) => WaitlistRegisterUserResponse.decode(_m0.Reader.create(data)));
    }
    GetCurrentUserStatus(request, metadata) {
        const data = Empty.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetCurrentUserStatus", data, metadata);
        return promise.then((data) => GetCurrentUserStatusResponse.decode(_m0.Reader.create(data)));
    }
    AcceptTermsAndConditions(request, metadata) {
        const data = Empty.encode(request).finish();
        const promise = this.rpc.request(this.service, "AcceptTermsAndConditions", data, metadata);
        return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
    }
    EnsureDeveloperAccountExists(request, metadata) {
        const data = Empty.encode(request).finish();
        const promise = this.rpc.request(this.service, "EnsureDeveloperAccountExists", data, metadata);
        return promise.then((data) => WaitlistRegisterUserResponse.decode(_m0.Reader.create(data)));
    }
}
export const WaitlistDefinition = {
    ...
    methods: {
        ...
        ensureDeveloperAccountExists: {
            name: "EnsureDeveloperAccountExists",
            requestType: Empty,
            requestStream: false,
            responseType: WaitlistRegisterUserResponse,
            responseStream: false,
