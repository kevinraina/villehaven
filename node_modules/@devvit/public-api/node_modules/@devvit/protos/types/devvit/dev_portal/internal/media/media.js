...
export const DevPortalMediaServiceName = "devvit.dev_portal.internal.media.DevPortalMedia";
export class DevPortalMediaClientImpl {
    constructor(rpc, opts) {
        this.service = opts?.service || DevPortalMediaServiceName;
        this.rpc = rpc;
        this.UpdateAssetStatus = this.UpdateAssetStatus.bind(this);
    }
    UpdateAssetStatus(request, metadata) {
        const data = UpdateAssetStatusRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "UpdateAssetStatus", data, metadata);
        return promise.then((data) => UpdateAssetStatusResponse.decode(_m0.Reader.create(data)));
    }
}
