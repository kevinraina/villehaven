...
export const TriggersServiceName = "devvit.gateway.v1alpha.Triggers";
export class TriggersClientImpl {
    constructor(rpc, opts) {
        this.service = opts?.service || TriggersServiceName;
        this.rpc = rpc;
    ...
    OnTrigger(request, metadata) {
        const data = TriggerEvent.encode(request).finish();
        const promise = this.rpc.request(this.service, "OnTrigger", data, metadata);
        return promise.then((data) => TriggerResponse.decode(_m0.Reader.create(data)));
    }
    OnFanOut(request, metadata) {
        const data = TriggerEvent.encode(request).finish();
        const promise = this.rpc.request(this.service, "OnFanOut", data, metadata);
        return promise.then((data) => TriggerFanOutResponse.decode(_m0.Reader.create(data)));
    }
    OnInvoke(request, metadata) {
        const data = TriggerInvocation.encode(request).finish();
        const promise = this.rpc.request(this.service, "OnInvoke", data, metadata);
        return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
    }
    OnInstall(request, metadata) {
        const data = InstallationInfo.encode(request).finish();
        const promise = this.rpc.request(this.service, "OnInstall", data, metadata);
        return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
    }
    OnUninstall(request, metadata) {
        const data = InstallationInfo.encode(request).finish();
        const promise = this.rpc.request(this.service, "OnUninstall", data, metadata);
        return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
    }
    OnInstallChanged(request, metadata) {
        const data = InstallationInfo.encode(request).finish();
        const promise = this.rpc.request(this.service, "OnInstallChanged", data, metadata);
        return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
    }
}
