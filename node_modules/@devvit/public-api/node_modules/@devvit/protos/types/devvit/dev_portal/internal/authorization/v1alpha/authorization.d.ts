...
export declare const DevPortalAuthInstalledAppResource: {
    ...
    create(base?: DeepPartial<DevPortalAuthInstalledAppResource>): DevPortalAuthInstalledAppResource;
    fromPartial(object: DeepPartial<DevPortalAuthInstalledAppResource>): DevPortalAuthInstalledAppResource;
};
export declare const DevPortalAuthAppVersionResource: {
    ...
    create(base?: DeepPartial<DevPortalAuthAppVersionResource>): DevPortalAuthAppVersionResource;
    fromPartial(object: DeepPartial<DevPortalAuthAppVersionResource>): DevPortalAuthAppVersionResource;
};
export declare const DevPortalAuthLocationResource: {
    ...
    create(base?: DeepPartial<DevPortalAuthLocationResource>): DevPortalAuthLocationResource;
    fromPartial(object: DeepPartial<DevPortalAuthLocationResource>): DevPortalAuthLocationResource;
};
export declare const DevPortalAuthCanViewLogsRequest: {
    ...
    create(base?: DeepPartial<DevPortalAuthCanViewLogsRequest>): DevPortalAuthCanViewLogsRequest;
    fromPartial(object: DeepPartial<DevPortalAuthCanViewLogsRequest>): DevPortalAuthCanViewLogsRequest;
};
export declare const DevPortalAuthorizationResponse: {
    ...
    create(base?: DeepPartial<DevPortalAuthorizationResponse>): DevPortalAuthorizationResponse;
    fromPartial(object: DeepPartial<DevPortalAuthorizationResponse>): DevPortalAuthorizationResponse;
};
...
export declare const DevPortalAuthorizationServiceName = "devvit.dev_portal.internal.authorization.v1alpha.DevPortalAuthorization";
