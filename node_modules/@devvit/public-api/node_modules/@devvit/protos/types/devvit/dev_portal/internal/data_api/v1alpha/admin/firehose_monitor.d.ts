...
export declare const CreateFirehoseMonitorDataTokenRequest: {
    ...
    create(base?: DeepPartial<CreateFirehoseMonitorDataTokenRequest>): CreateFirehoseMonitorDataTokenRequest;
    fromPartial(object: DeepPartial<CreateFirehoseMonitorDataTokenRequest>): CreateFirehoseMonitorDataTokenRequest;
};
export declare const GetFirehoseMonitorSubscriptionByNameRequest: {
    ...
    create(base?: DeepPartial<GetFirehoseMonitorSubscriptionByNameRequest>): GetFirehoseMonitorSubscriptionByNameRequest;
    fromPartial(object: DeepPartial<GetFirehoseMonitorSubscriptionByNameRequest>): GetFirehoseMonitorSubscriptionByNameRequest;
};
export declare const GetFirehoseMonitorSubscriptionByNameResponse: {
    ...
    create(base?: DeepPartial<GetFirehoseMonitorSubscriptionByNameResponse>): GetFirehoseMonitorSubscriptionByNameResponse;
    fromPartial(object: DeepPartial<GetFirehoseMonitorSubscriptionByNameResponse>): GetFirehoseMonitorSubscriptionByNameResponse;
};
