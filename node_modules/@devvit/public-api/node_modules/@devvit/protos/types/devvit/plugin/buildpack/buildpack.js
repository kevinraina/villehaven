...
export const BuildPackServiceName = "devvit.plugin.buildpack.BuildPack";
export class BuildPackClientImpl {
    constructor(rpc, opts) {
        this.service = opts?.service || BuildPackServiceName;
        this.rpc = rpc;
    ...
    Compile(request, metadata) {
        ...
        const promise = this.rpc.request(this.service, "Compile", data, metadata);
    ...
    Watch(request, metadata) {
        ...
        return result.pipe(map((data) => CompileResponse.decode(_m0.Reader.create(data))));
    }
}
