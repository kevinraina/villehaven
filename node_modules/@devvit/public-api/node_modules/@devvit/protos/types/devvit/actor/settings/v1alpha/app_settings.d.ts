...
export declare const AppSettingsServiceName = "devvit.actor.settings.v1alpha.AppSettings";
export declare class AppSettingsClientImpl implements AppSettings {
 ...
 * Load the saved values with the Settings plugin.
 */
export type AppSettingsDefinition = typeof AppSettingsDefinition;
export declare const AppSettingsDefinition: {
