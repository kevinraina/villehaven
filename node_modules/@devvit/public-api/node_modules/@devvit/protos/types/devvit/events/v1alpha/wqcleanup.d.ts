...
export interface WqCleanup {
    cursor: number;
}
export declare const WqCleanup: {
    ...
    create(base?: DeepPartial<WqCleanup>): WqCleanup;
    fromPartial(object: DeepPartial<WqCleanup>): WqCleanup;
};
...
export {};
//# sourceMappingURL=wqcleanup.d.ts.map