...
export class DevPortalAppPublishRequestClientJSON {
    ...
    AddReview(request) {
        const data = AppPRAddReviewRequest.toJSON(request);
        const promise = this.rpc.request('devvit.dev_portal.DevPortalAppPublishRequest', 'AddReview', 'application/json', data);
        return promise.then((data) => UUID.fromJSON(data));
    }
    UpdateReview(request) {
        const data = AppPRUpdateReviewRequest.toJSON(request);
        const promise = this.rpc.request('devvit.dev_portal.DevPortalAppPublishRequest', 'UpdateReview', 'application/json', data);
        return promise.then((data) => Empty.fromJSON(data));
    }
...
export class DevPortalAppPublishRequestClientProtobuf {
    ...
    AddReview(request) {
        const data = AppPRAddReviewRequest.encode(request).finish();
        const promise = this.rpc.request('devvit.dev_portal.DevPortalAppPublishRequest', 'AddReview', 'application/protobuf', data);
        return promise.then((data) => UUID.decode(data));
    }
    UpdateReview(request) {
        const data = AppPRUpdateReviewRequest.encode(request).finish();
        const promise = this.rpc.request('devvit.dev_portal.DevPortalAppPublishRequest', 'UpdateReview', 'application/protobuf', data);
        return promise.then((data) => Empty.decode(data));
    }
    RemoveReview(request) {
        const data = UUID.encode(request).finish();
