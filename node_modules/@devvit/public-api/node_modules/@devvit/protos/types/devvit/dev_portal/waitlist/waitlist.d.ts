...
export declare const IsCurrentUserRegisteredResponse: {
    ...
    create(base?: DeepPartial<IsCurrentUserRegisteredResponse>): IsCurrentUserRegisteredResponse;
    fromPartial(object: DeepPartial<IsCurrentUserRegisteredResponse>): IsCurrentUserRegisteredResponse;
};
export declare const WaitlistRegisterUserRequest: {
    ...
    create(base?: DeepPartial<WaitlistRegisterUserRequest>): WaitlistRegisterUserRequest;
    fromPartial(object: DeepPartial<WaitlistRegisterUserRequest>): WaitlistRegisterUserRequest;
};
export declare const WaitlistRegisterUserRequest_ProgrammingExperienceEntry: {
    ...
    create(base?: DeepPartial<WaitlistRegisterUserRequest_ProgrammingExperienceEntry>): WaitlistRegisterUserRequest_ProgrammingExperienceEntry;
    fromPartial(object: DeepPartial<WaitlistRegisterUserRequest_ProgrammingExperienceEntry>): WaitlistRegisterUserRequest_ProgrammingExperienceEntry;
};
export declare const WaitlistRegisterUserResponse: {
    ...
    create(base?: DeepPartial<WaitlistRegisterUserResponse>): WaitlistRegisterUserResponse;
    fromPartial(object: DeepPartial<WaitlistRegisterUserResponse>): WaitlistRegisterUserResponse;
};
export declare const GetCurrentUserStatusResponse: {
    ...
    create(base?: DeepPartial<GetCurrentUserStatusResponse>): GetCurrentUserStatusResponse;
    fromPartial(object: DeepPartial<GetCurrentUserStatusResponse>): GetCurrentUserStatusResponse;
};
export interface Waitlist {
    ...
    EnsureDeveloperAccountExists(request: Empty, metadata?: Metadata): Promise<WaitlistRegisterUserResponse>;
}
export declare const WaitlistServiceName = "devvit.dev_portal.waitlist.Waitlist";
...
export declare const WaitlistDefinition: {
    ...
    readonly methods: {
        ...
        readonly ensureDeveloperAccountExists: {
            readonly name: "EnsureDeveloperAccountExists";
            readonly requestType: {
                $type: "google.protobuf.Empty";
                encode(_: Empty, writer?: _m0.Writer): _m0.Writer;
                decode(input: _m0.Reader | Uint8Array, length?: number | undefined): Empty;
