...
export declare const WorkerQuery: {
    ...
    create(base?: DeepPartial<WorkerQuery>): WorkerQuery;
    fromPartial(object: DeepPartial<WorkerQuery>): WorkerQuery;
};
...
export declare const RuntimeActorServiceName = "devvit.runtime.actor.RuntimeActor";
