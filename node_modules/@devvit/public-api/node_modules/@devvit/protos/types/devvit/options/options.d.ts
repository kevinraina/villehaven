...
export declare const EventSpec: {
    ...
    create(base?: DeepPartial<EventSpec>): EventSpec;
    fromPartial(object: DeepPartial<EventSpec>): EventSpec;
};
export declare const DeliverTo: {
    ...
    create(base?: DeepPartial<DeliverTo>): DeliverTo;
    fromPartial(object: DeepPartial<DeliverTo>): DeliverTo;
};
